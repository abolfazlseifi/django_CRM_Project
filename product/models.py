...
class Product(models.Model):
    ...
    file_pdf = models.FileField(upload_to=upload_pdf_path, verbose_name='کاتولوگ محصول', blank=True,
                                validators=[FileExtensionValidator(['pdf'])] )
    file_image = models.ImageField(upload_to=upload_image_path, verbose_name='تصویر محصول', blank=True)
